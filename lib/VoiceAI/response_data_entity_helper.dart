import 'response_data_entity.dart';
...
resultFromJson(Result data, Map<String, dynamic> json) {
  ...
  if (json['ed'] != null) {
    data.ed =
        json['ed'] is String ? int.tryParse(json['ed']) : json['ed'].toInt();
  }
  if (json['pgs'] != null) {
...
cwFromJson(Cw data, Map<String, dynamic> json) {
  if (json['sc'] != null) {
    data.sc =
        json['sc'] is String ? int.tryParse(json['sc']) : json['sc'].toInt();
  }
  if (json['w'] != null) {
