...
//       new MaterialButton(
//         color: Colors.blue,
//         child: new Text('点击报名',style: TextStyle(
//           fontSize: 16.0,
//           fontWeight: FontWeight.bold,
//         ),),
//         onPressed: () {
...
//                 title: new Text('你是否听完陆老师的前三节理论课',style: TextStyle(
//                   fontSize: 16.0,
//                   fontWeight: FontWeight.bold,
//                 ),),
//                 children: <Widget>[
//                   new Text('报名前必须听完前三节课',textAlign:TextAlign.center,style: TextStyle(
//                     fontSize: 10.0,
//                     fontWeight: FontWeight.bold,
//                   ),),
//                   new ElevatedButton(
...
//                           builder:(context) =>new TrainFile()) //Navigator.push：是跳转到下一个页面，它要接受两个参数一个是上下文context，另一个是要跳转的函数。
//                       );
//                     },
//                   ),
//                   new ElevatedButton(
//                     child: new Text('没听完，现在去听'),
//                     onPressed: () {
//                       Navigator.of(context).pop();  //跳转到视频页面
//                     },
//                   ),
//                   Container(
//
//                     width:200.0,
//                     height:50.0,
//                     padding:const EdgeInsets.fromLTRB(130.0,30.0,0.0,0.0),//文字和容器间的距离
//                     margin: const EdgeInsets.all(10.0),//容器外距离整个home的距离
//                     child:
//                     new ElevatedButton(
//                       child: new Text('返回'),
//                       onPressed: () {
...
//       //           title: new Text('你是否听完陆老师的前三节理论课'),
