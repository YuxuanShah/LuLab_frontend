...
//请求数据
RecordAddRequest recordAddRequestFromJson(String str) => RecordAddRequest.fromJson(json.decode(str));

String recordAddRequestToJson(RecordAddRequest data) => json.encode(data.toJson());
...
class RecordAddRequest {
  ...
  factory RecordAddRequest.fromJson(Map<String, dynamic> json) => RecordAddRequest(
